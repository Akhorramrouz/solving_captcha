...
class Test_filters:
    ...
    def __init__(self, path='src/data/results_of_testing_filters'):
        os.mkdir("src/data/results_of_testing_filters")
        gray_images = []
        file_names = []
        original_images = []
        for file_name in os.listdir("src/data/results_of_testing_filters/"):
            if file_name.endswith('.jpg'):
                original_image = cv2.imread(f'src/data/results_of_testing_filters/{file_name}',0)
    ...
    def save_grid_images(self, images,title):
        ...
        plt.savefig(f"src/data/results_of_testing_filters/{title}"+ '.jpg')
        plt.close('all')
    ...
    def test_canny_filter(self, images):
        ...
        self.canny_images = canny_images
    ...
    def test_sobel_filter(self, images):
        ...
        self.sobel_images = sobel_images
    ...
    def test_dilation_filter(self, images):
        ...
        self.dilation_images = dilation_images
    ...
    def test_opening_filter(self, images):
        ...
        self.opening_images = opening_images
    ...
    def test_closing_filter(self, images):
        ...
        self.closing_images = closing_images
    ...
    def test_gradient_filter(self, images):
        ...
        self.gradient_images = gradient_images
    ...
    def test_tophat_filter(self, images):
        ...
        self.tophat_images = tophat_images
    ...
    def test_median_filter(self, images):
        ...
        self.median_images = median_images
    ...
    def test_bilateral_filter(self, images):
        ...
        self.bilateral_images = bilateral_images
